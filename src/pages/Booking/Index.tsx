...
const Booking: React.FC = () => {
  ...
  return (
    <IonPage className='px-3'>
      <IonRow className='p-1 justify-between items-center'>
      ...
      <IonRow className='flex text-center p-1'>
        <IonCol className='flex-1 py-3 mr-0 ion-activatable ripple-parent bg-amber-400 rounded-s-lg relative text-white'>
          ...
          <IonBadge class='absolute -top-1 -left-1 rounded-full w-4 h-4 block' color='danger'></IonBadge>
        </IonCol>
      ...
      <IonContent>
        <IonList lines='full'>
          {/* requested */}
          <IonItem onClick={routeChat} className='active:scale-95'>
            ...
            <IonText class='p-2 text-sm border-amber-400 text-amber-400 border rounded-lg relative my-3' slot='end'>
              ...
              <IonBadge class='absolute -top-1 -right-1 rounded-full w-4 h-4 block' color='danger'></IonBadge>
            </IonText>
          </IonItem>

          {/* paid */}
          <IonItem className='active:scale-95'>
            <IonAvatar className='w-12 h-12 my-3'>
              <img src={imgAvater}/>
            </IonAvatar>
            <IonRow className='flex flex-col text-start ml-2 my-3'>
      ...
      <FilterModal isOpen={filterOpen} className='flex flex-row h-full items-center justify-center w-fit-content'>
        <IonCard className='relative bg-white'>
          <IonIcon className='absolute top-3 right-3 z-10' onClick={()=>setFilterOpen(false)} icon={closeOutline} size='primary' />
