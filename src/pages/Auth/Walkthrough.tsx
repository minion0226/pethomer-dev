...
const Walkthrough: React.FC = () => {
  ...
  return (
    <IonPage className='relative flex h-full' onClick={handleClick}>
      ...
      <IonRow className='flex flex-col justify-end items-center z-10 pb-3 px-6 relative'>
        ...
        <IonRow className='w-full flex justify-between items-center z-10'>
          <IonButton className='text-white uppercase' fill='clear' onClick={() => router.push('/login')}>{t('base.button.skip')}</IonButton>
          <IonRow>
